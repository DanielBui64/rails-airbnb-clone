...
user2 = User.create!(first_name: "David", last_name: "Attar", phone_number: "514-987-6543", email: "david@attar.ca", password: "mypassword", date_of_birth: Date.new(2001,2,3), owner: "true")
...
user3 = User.create!(first_name: "Daniel", last_name: "Bui", phone_number: "514-123-4567", email: "daniel@bui.ca", password: "mypassword", date_of_birth: Date.new(2001,2,3), owner: "false")
...
boat5 = Boat.create!(name: "Rover", make_model_year: "Rover 599 2010", location: "90 Bd Arthur-Sauvé, Saint-Eustache, QC J7R 2H7", price_per_day: 12000, description: "Rover 599 ready for rent, 11 bedrooms, 3 bathrooms, 1 kitchen, and swimming pool.", capacity: 24, rating: 3, user: user3)
...
boat8 = Boat.create!(name: "Speedo MK II", make_model_year: "Speedo MKII 2012", location: "9100 Bd des Mille-Îles, Laval, QC H7A 4C6", price_per_day: 1000, description: "Perfect sized boat for exploring! Rent for the weekend and get Monday Free! Bluetooth audio and GPS included.", capacity: 7, rating: 3, user: user3)
...
boat9 = Boat.create!(name: "Big Liner", make_model_year: "E78 Big Liner 2017", location: "380 Sussex Dr, Ottawa, ON K1N 9N4", price_per_day: 10, description: "E78 Big Liner, 19 seater, 5 bedrooms, 3 floors and 3 bathrooms with 2 showers. Big living space and large kitchen perfect for cooking!", capacity: 19, rating: 3, user: user3)
...
boat10 = Boat.create!(name: "LeSmallBoat", make_model_year: "Yacht 1960", location: "22 Chemin Macdonald, Montréal, QC H3C 6A3", price_per_day: 10, description: "Smallest boat in quebec!", capacity: 2, rating: 3, user: user3)
